...
{
    class SpeedModeVsBot: StandardVsBot
    {
        ...
        public string[] TileAndMarkSpeedBot(string[] arr, string currentMark, string currentPlayer, float perTurnValue, float gameTimeValue)
        {
        ...
        public string[] ThreeByThreeSpeedBot(string currentPlayer, string fplayer, string splayer, float timerPerTurn, float gameTime)
        {
            ...
            do
            {
                ...
                turnInfo_arr = TileAndMarkSpeedBot(easy_arr, currentMark, currentPlayer, timerPerTurn, gameTime);
                if (!timer_Status)
                {
        ...
        public string[] SixBySixSpeedBot(string currentPlayer, string fplayer, string splayer, float timerPerTurn, float gameTime)
        {
            string currentMark = "X"; int status_Value; int tile_Num; string[] turnInfo_arr;
            ...
            do
            {
                turnInfo_arr = TileAndMarkSpeedBot(normal_arr, currentMark, currentPlayer, timerPerTurn, gameTime);
                if (!timer_Status)
                {
                    GameTimer.CreateandRunTimer();
                    timer_Status = true;
        ...
        public string[] TenByTenBotSpeed(string currentPlayer, string fplayer, string splayer, float timerPerTurn, float gameTime)
        {
            string currentMark = "X"; int status_Value; int tile_Num; string[] turnInfo_arr;
            ...
            do
            {
                ...
                turnInfo_arr = TileAndMarkSpeedBot(hard_arr, currentMark, currentPlayer, timerPerTurn, gameTime);
                if (!timer_Status)
                {
                    GameTimer.CreateandRunTimer();
                    timer_Status = true;
